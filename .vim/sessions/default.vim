...
nnoremap ;fb :Buffers
nnoremap ;fl :Files
nnoremap ;fpp :FloatermPrev
nnoremap ;fnn :FloatermNext
nnoremap ;ft :FloatermToggle
nnoremap ;fn :FloatermNew
noremap H ^
noremap L $
...
inoremap  
inoremap <silent> <expr> " coc#_insert_key('request', '8aaa6cb9-5972-11ea-900f-57093b014473')
inoremap <silent> <expr> ' coc#_insert_key('request', '8aaa6cb8-5972-11ea-900f-57093b014473')
inoremap <silent> <expr> ( coc#_insert_key('request', '8aaa6cb0-5972-11ea-900f-57093b014473')
inoremap <silent> <expr> ) coc#_insert_key('request', '8aaa6cb1-5972-11ea-900f-57093b014473')
inoremap <silent> <expr> < coc#_insert_key('request', '8aaa6cb6-5972-11ea-900f-57093b014473')
inoremap <silent> <expr> > coc#_insert_key('request', '8aaa6cb7-5972-11ea-900f-57093b014473')
inoremap <silent> <expr> [ coc#_insert_key('request', '8aaa6cb2-5972-11ea-900f-57093b014473')
inoremap <silent> <expr> ] coc#_insert_key('request', '8aaa6cb3-5972-11ea-900f-57093b014473')
inoremap <silent> <expr> ` coc#_insert_key('request', '8aaa6cba-5972-11ea-900f-57093b014473')
imap kj 
inoremap <silent> <expr> { coc#_insert_key('request', '8aaa6cb4-5972-11ea-900f-57093b014473')
inoremap <silent> <expr> } coc#_insert_key('request', '8aaa6cb5-5972-11ea-900f-57093b014473')
let &cpo=s:cpo_save
unlet s:cpo_save
set autoindent
set autoread
...
silent! normal! zE
let s:l = 69 - ((19 * winheight(0) + 15) / 31)
