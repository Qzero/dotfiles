...
nmap <D-v> "*P
inoremap  
inoremap <silent> <expr> " coc#_insert_key('request', '4c6fd511-5973-11ea-a6f6-f96bdb23a0b1')
inoremap <silent> <expr> ' coc#_insert_key('request', '4c6fd510-5973-11ea-a6f6-f96bdb23a0b1')
inoremap <silent> <expr> ( coc#_insert_key('request', '4c6fae00-5973-11ea-a6f6-f96bdb23a0b1')
inoremap <silent> <expr> ) coc#_insert_key('request', '4c6fae01-5973-11ea-a6f6-f96bdb23a0b1')
inoremap <silent> <expr> < coc#_insert_key('request', '4c6fae06-5973-11ea-a6f6-f96bdb23a0b1')
inoremap <silent> <expr> > coc#_insert_key('request', '4c6fae07-5973-11ea-a6f6-f96bdb23a0b1')
inoremap <silent> <expr> [ coc#_insert_key('request', '4c6fae02-5973-11ea-a6f6-f96bdb23a0b1')
inoremap <silent> <expr> ] coc#_insert_key('request', '4c6fae03-5973-11ea-a6f6-f96bdb23a0b1')
inoremap <silent> <expr> ` coc#_insert_key('request', '4c6fd512-5973-11ea-a6f6-f96bdb23a0b1')
imap kj 
inoremap <silent> <expr> { coc#_insert_key('request', '4c6fae04-5973-11ea-a6f6-f96bdb23a0b1')
inoremap <silent> <expr> } coc#_insert_key('request', '4c6fae05-5973-11ea-a6f6-f96bdb23a0b1')
let &cpo=s:cpo_save
unlet s:cpo_save
set autoindent
set autoread
...
silent! normal! zE
let s:l = 91 - ((24 * winheight(0) + 15) / 31)
